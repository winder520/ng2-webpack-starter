...
define(function(require, exports, module) {
    ...
    require('./core/patch');
    //形状
    require('./shape/complex-shape/defaut');
    require('./shape/complex-shape/advanced');
    require('./shape/complex-shape/enum');
    require('./shape/complex-shape/property');
    require('./shape/complex-shape/instance');
    require('./shape/complex-shape/property-restriction');
    require('./shape/complex-shape/data-property');
    require('./shape/complex-shape/root');
    require('./shape/complex-shape/file-folder');
