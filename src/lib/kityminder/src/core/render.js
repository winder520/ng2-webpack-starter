define(function (require, exports, module) {
            ...
            renderNodeBatch: function (nodes) {
                ...
                for (i = 0; i < rendererCount; i++) {
                    ...
                    for (j = 0; j < nodes.length; j++) {
                        ...
                        // 判断当前上下文是否应该渲染
                        if (renderer.shouldRender(node) && node.isVisible(true)) {
    ...
    kity.extendClass(MinderNode, {
        ...
        getContentBox: function () {
            ...
            return !this.isVisible(true) || (this.parent && this.parent.isCollapsed()) ? new kity.Box() : (this._contentBox || new kity.Box());
        },
