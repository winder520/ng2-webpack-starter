define(function (require, exports, module) {
    ...
    var TreeDragger = kity.createClass('TreeDragger', {
        ...
        _dropTest: function () {
            ...
            if (this._dropSucceedTarget && this._dropSucceedTarget.getRenderContainer().getAttr('display') === 'none') {
                this._dropSucceedTarget = null;
            }
        ...
        _renderDropHint: function (target) {
            //todo 拖动到节点上面的时候
            //console.log(this._dragSources[0], target);

            this._dropHinter.render(target);
        },

        _renderOrderHint: function (hint) {
            if(hint && hint.node.getRenderContainer().getAttr('display')==='none'){
                hint=null;
            }
            //禁用停靠
            hint=null;
